        ...
        <div class="container">
            ...
            <div class="review-list mb-5">
                <div class="review-item bg-light p-4 rounded mb-4">
                    <h4>Juan Pérez</h4>
                    <p><em>"Los chifles son deliciosos y perfectos para compartir con amigos. ¡Definitivamente los
                            recomiendo!"</em></p>
                    <div class="rating">
                        ⭐⭐⭐⭐⭐
                    </div>
    ...
    <footer class="footer text-faded text-center py-5">
        <div class="container">
            ...
            <div class="social-icons mt-3">
                ...
                <a href="https://www.instagram.com/solochifles?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
